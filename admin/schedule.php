    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-psychiatrist ">
                        <a href="psychiatrists.php" class="non-style-link-menu "><div><p class="menu-text">Psychiatrists</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="psyid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Psychiatrist Name from the list</option><br/>
                                
                            <?php 
                            
                                $list11 = $database->query("select  * from  Psychiatrist order by psyname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlpt2="";
                        if(!empty($_POST["psyid"])){
                            $docid=$_POST["psyid"];
                            $sqlpt2=" Psychiatrist.psyid=$docid ";
                        }
                            $sqlmain= "select schedule.scheduleid,schedule.title,Psychiatrist.psyname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join Psychiatrist on schedule.psyid=Psychiatrist.psyid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,Psychiatrist.psyname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join Psychiatrist on schedule.psyid=Psychiatrist.psyid  order by schedule.scheduledate desc";
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        <table width="80%" class="sub-table scrolldown add-psy-form-container" border="0">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="psyid" class="form-label">Select Psychiatrist: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="psyid" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Psychiatrist Name from the list</option><br/>';
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,Psychiatrist.psyname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join Psychiatrist on schedule.psyid=Psychiatrist.psyid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["psyname"];
            $scheduleid=$row["scheduleid"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-psychiatrist-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Psychiatrist of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
